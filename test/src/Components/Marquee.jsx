...
const Marquee = ({ MarqueeData, isVertical }) => {
  ...
  return (
    <Box
      ...
      height={isVertical ? "527px" : undefined}
      // whiteSpace={"nowrap"}
      borderWidth="1px"
      ...
      boxShadow={
        isVertical
          ...
          : "rgba(100, 100, 111, 0.2) 0px 0px -15px 0px"
      }
    >
      <Box className="marquee" as="div" css={marqueeStyles}>
          ...
          isVertical ? (
            ...
            >
              ...
              {index === MarqueeData.length - 1 ? (
                <Divider size="md" my={12} borderColor="black.300" />
              ) : undefined}
            </Box>
          ) : (
            <Box
              ...
              fontWeight={"600"}
              borderRight={
                index === MarqueeData.length - 1 ? "1px solid black" : undefined
              }
              padding={"0px 50px"}
            >
              <Link>{ele}</Link>
